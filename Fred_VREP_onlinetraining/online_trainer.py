...
class OnlineTrainer:
    ...
    def train(self, target):
        ...
        while self.running:
            ...
            network_input[0] = distance
            network_input[1] = diff_theta

            # print("valeur de u :", u)
            # print("valeur de v :", v)
            # print("valeur de theta_voulu : ", theta_voulu)
            # print("valeur de theta_actu : ", theta_actu)
            print("valeur de diff_theta : ", diff_theta)
            ...
            if self.training:
                ...
                print("valeur de distance : ", distance)

                grad = [- (command[0] - (2 / (1 + math.exp(-(theta_voulu - theta_actu))) - 1)),
                        (command[1] - (1/(1+abs(diff_theta))) / (1 + math.exp(-4 * (distance-1))))
                        ]
